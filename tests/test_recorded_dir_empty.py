...
Test Name: dir-empty
Generated: 2025-06-12 15:58:25 UTC
Command: python onefilellm.py empty_dir/

Recorded test for: empty_dir/
...
class TestRecordedDir_Empty:
    ...
    def test_dir_empty(self, snapshot):
        ...
        snapshot.assert_match(output, "dir_empty_8bbfaf09")
    
    def test_dir_empty_success_expectation(self):
        """
