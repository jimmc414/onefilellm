...
Test Name: github-k8s
Generated: 2025-06-12 15:52:28 UTC
Command: python onefilellm.py https://github.com/kubernetes/kubernetes

Recorded test for: https://github.com/kubernetes/kubernetes
...
class TestRecordedGithub_K8S:
    """Auto-generated test class for recorded command execution."""
    
    def test_github_k8s(self, snapshot):
        """
        Recorded test for: https://github.com/kubernetes/kubernetes
        
        This test captures the exact output of running:
        python onefilellm.py https://github.com/kubernetes/kubernetes
        """
        ...
        snapshot.assert_match(output, "github_k8s_3dbad75a")
    
    def test_github_k8s_success_expectation(self):
        """
