...
Test Name: crawl-k8s-concepts
Generated: 2025-06-12 16:00:41 UTC
Command: python onefilellm.py https://kubernetes.io/docs/concepts/ --crawl-max-depth 3 --crawl-restrict-path --crawl-delay 0.5

Recorded test for: https://kubernetes.io/docs/concepts/ --crawl-max-depth 3 --crawl-restrict-path --crawl-delay 0.5
...
class TestRecordedCrawl_K8S_Concepts:
    """Auto-generated test class for recorded command execution."""
    
    def test_crawl_k8s_concepts(self, snapshot):
        """
        Recorded test for: https://kubernetes.io/docs/concepts/ --crawl-max-depth 3 --crawl-restrict-path --crawl-delay 0.5
        
        This test captures the exact output of running:
        python onefilellm.py https://kubernetes.io/docs/concepts/ --crawl-max-depth 3 --crawl-restrict-path --crawl-delay 0.5
        """
        # Execute the command that was recorded
        args = ['https://kubernetes.io/docs/concepts/', '--crawl-max-depth', '3', '--crawl-restrict-path', '--crawl-delay', '0.5']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "crawl_k8s_concepts_28839a88")
    
    def test_crawl_k8s_concepts_success_expectation(self):
        """
