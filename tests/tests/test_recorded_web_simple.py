...
Generated: 2025-06-12 15:55:37 UTC
Command: python onefilellm.py https://example.com

Recorded test for: https://example.com
...
class TestRecordedWeb_Simple:
    ...
    def test_web_simple(self, snapshot):
        ...
        snapshot.assert_match(output, "web_simple_c984d06a")
    
    def test_web_simple_success_expectation(self):
        """
