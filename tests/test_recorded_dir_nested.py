...
Test Name: dir-nested
Generated: 2025-06-12 15:58:56 UTC
Command: python onefilellm.py tests/snapshots/

Recorded test for: tests/snapshots/
...
@pytest.mark.unit
class TestRecordedDir_Nested:
    """Auto-generated test class for recorded command execution."""
    
    def test_dir_nested(self, snapshot):
        """
        Recorded test for: tests/snapshots/
        
        This test captures the exact output of running:
        python onefilellm.py tests/snapshots/
        """
        # Execute the command that was recorded
        args = ['tests/snapshots/']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "dir_nested_7da48f6f")
    
    def test_dir_nested_success_expectation(self):
        """
