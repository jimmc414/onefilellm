...
Test Name: local-python-file
Generated: 2025-06-12 15:52:31 UTC
Command: python onefilellm.py onefilellm.py

Recorded test for: onefilellm.py
...
@pytest.mark.unit
class TestRecordedLocal_Python_File:
    """Auto-generated test class for recorded command execution."""
    
    def test_local_python_file(self, snapshot):
        """
        Recorded test for: onefilellm.py
        
        This test captures the exact output of running:
        python onefilellm.py onefilellm.py
        """
        ...
        snapshot.assert_match(output, "local_python_file_45bd8863")
    
    def test_local_python_file_success_expectation(self):
        """
