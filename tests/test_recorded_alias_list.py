...
Test Name: alias-list
Generated: 2025-06-12 15:56:24 UTC
Command: python onefilellm.py --alias-list

Recorded test for: --alias-list
...
@pytest.mark.unit
@pytest.mark.alias
class TestRecordedAlias_List:
    """Auto-generated test class for recorded command execution."""
    
    def test_alias_list(self, snapshot):
        """
        Recorded test for: --alias-list
        ...
        snapshot.assert_match(output, "alias_list_b0173b83")
    
    def test_alias_list_success_expectation(self):
        """
