...
Test Name: alias-core-search
Generated: 2025-06-12 15:56:07 UTC
Command: python onefilellm.py gh_search python parser

Recorded test for: gh_search python parser
...
@pytest.mark.unit
@pytest.mark.alias
class TestRecordedAlias_Core_Search:
    """Auto-generated test class for recorded command execution."""
    
    def test_alias_core_search(self, snapshot):
        """
        Recorded test for: gh_search python parser
        
        This test captures the exact output of running:
        python onefilellm.py gh_search python parser
        """
        # Execute the command that was recorded
        args = ['gh_search', 'python parser']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "alias_core_search_1b8fa9c2")
    
    def test_alias_core_search_success_expectation(self):
        """
