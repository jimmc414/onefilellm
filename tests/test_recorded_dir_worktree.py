...
Test Name: dir-worktree
Generated: 2025-06-12 16:01:13 UTC
Command: python onefilellm.py worktree-claude-1/

Recorded test for: worktree-claude-1/
...
@pytest.mark.unit
class TestRecordedDir_Worktree:
    """Auto-generated test class for recorded command execution."""
    
    def test_dir_worktree(self, snapshot):
        """
        Recorded test for: worktree-claude-1/
        
        This test captures the exact output of running:
        python onefilellm.py worktree-claude-1/
        """
        # Execute the command that was recorded
        args = ['worktree-claude-1/']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "dir_worktree_26064b68")
    
    def test_dir_worktree_success_expectation(self):
        """
