...
Test Name: stdin-empty
Generated: 2025-06-12 15:52:45 UTC
...
@pytest.mark.unit
@pytest.mark.cli
class TestRecordedStdin_Empty:
    """Auto-generated test class for recorded command execution."""
    
    def test_stdin_empty(self, snapshot):
        """
        Recorded test for: -
        ...
        snapshot.assert_match(output, "stdin_empty_336d5ebc")
    
    def test_stdin_empty_success_expectation(self):
        """
