...
Test Name: github-branch
Generated: 2025-06-12 15:53:16 UTC
Command: python onefilellm.py https://github.com/openai/whisper/tree/main/whisper

Recorded test for: https://github.com/openai/whisper/tree/main/whisper
...
class TestRecordedGithub_Branch:
    """Auto-generated test class for recorded command execution."""
    
    def test_github_branch(self, snapshot):
        """
        Recorded test for: https://github.com/openai/whisper/tree/main/whisper
        ...
        args = ['https://github.com/openai/whisper/tree/main/whisper']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "github_branch_8dd67b5f")
    
    def test_github_branch_success_expectation(self):
        """
