...
Test Name: stdin-git-diff
Generated: 2025-06-12 15:52:26 UTC
...
@pytest.mark.unit
@pytest.mark.cli
class TestRecordedStdin_Git_Diff:
    """Auto-generated test class for recorded command execution."""
    
    def test_stdin_git_diff(self, snapshot):
        """
        Recorded test for: -
        ...
        snapshot.assert_match(output, "stdin_git_diff_336d5ebc")
    
    def test_stdin_git_diff_success_expectation(self):
        """
