...
Test Name: local-text-file
Generated: 2025-06-12 15:52:03 UTC
Command: python onefilellm.py readme.md

Recorded test for: readme.md
...
class TestRecordedLocal_Text_File:
    ...
    def test_local_text_file(self, snapshot):
        ...
        snapshot.assert_match(output, "local_text_file_0730bb7c")
    
    def test_local_text_file_success_expectation(self):
        """
