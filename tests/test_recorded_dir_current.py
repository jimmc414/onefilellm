...
Test Name: dir-current
Generated: 2025-06-12 16:00:46 UTC
...
@pytest.mark.unit
class TestRecordedDir_Current:
    """Auto-generated test class for recorded command execution."""
    
    def test_dir_current(self, snapshot):
        """
        Recorded test for: ./
        ...
        snapshot.assert_match(output, "dir_current_0374ec85")
    
    def test_dir_current_success_expectation(self):
        """
