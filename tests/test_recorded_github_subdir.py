...
Test Name: github-subdir
Generated: 2025-06-12 15:53:37 UTC
Command: python onefilellm.py https://github.com/vercel/ai/tree/main/packages

Recorded test for: https://github.com/vercel/ai/tree/main/packages
...
class TestRecordedGithub_Subdir:
    """Auto-generated test class for recorded command execution."""
    
    def test_github_subdir(self, snapshot):
        """
        Recorded test for: https://github.com/vercel/ai/tree/main/packages
        
        This test captures the exact output of running:
        python onefilellm.py https://github.com/vercel/ai/tree/main/packages
        """
        # Execute the command that was recorded
        args = ['https://github.com/vercel/ai/tree/main/packages']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "github_subdir_4c4db412")
    
    def test_github_subdir_success_expectation(self):
        """
