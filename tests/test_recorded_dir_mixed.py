...
Test Name: dir-mixed
Generated: 2025-06-12 15:57:57 UTC
...
@pytest.mark.unit
class TestRecordedDir_Mixed:
    """Auto-generated test class for recorded command execution."""
    
    def test_dir_mixed(self, snapshot):
        """
        Recorded test for: extras/
        ...
        snapshot.assert_match(output, "dir_mixed_1510bd74")
    
    def test_dir_mixed_success_expectation(self):
        """
