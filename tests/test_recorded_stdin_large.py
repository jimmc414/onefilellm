...
Test Name: stdin-large
Generated: 2025-06-12 15:52:08 UTC
...
@pytest.mark.unit
@pytest.mark.cli
class TestRecordedStdin_Large:
    """Auto-generated test class for recorded command execution."""
    
    def test_stdin_large(self, snapshot):
        """
        Recorded test for: -
        ...
        snapshot.assert_match(output, "stdin_large_336d5ebc")
    
    def test_stdin_large_success_expectation(self):
        """
