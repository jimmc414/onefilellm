...
Test Name: format-markdown
Generated: 2025-06-12 16:03:58 UTC
Command: python onefilellm.py readme.md --format markdown

Recorded test for: readme.md --format markdown
...
@pytest.mark.unit
class TestRecordedFormat_Markdown:
    """Auto-generated test class for recorded command execution."""
    
    def test_format_markdown(self, snapshot):
        """
        Recorded test for: readme.md --format markdown
        
        This test captures the exact output of running:
        python onefilellm.py readme.md --format markdown
        """
        # Execute the command that was recorded
        args = ['readme.md', '--format', 'markdown']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "format_markdown_9cfbd6a9")
    
    def test_format_markdown_success_expectation(self):
        """
