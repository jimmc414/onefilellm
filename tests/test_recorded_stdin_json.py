...
Test Name: stdin-json
Generated: 2025-06-12 15:51:32 UTC
Command: python onefilellm.py - --format json

Recorded test for: - --format json
...
class TestRecordedStdin_Json:
    ...
    def test_stdin_json(self, snapshot):
        ...
        snapshot.assert_match(output, "stdin_json_94f15f83")
    
    def test_stdin_json_success_expectation(self):
        """
