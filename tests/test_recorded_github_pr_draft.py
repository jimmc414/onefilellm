...
Test Name: github-pr-draft
Generated: 2025-06-12 16:04:36 UTC
Command: python onefilellm.py https://github.com/vercel/next.js/pull/40000

Recorded test for: https://github.com/vercel/next.js/pull/40000
...
class TestRecordedGithub_Pr_Draft:
    """Auto-generated test class for recorded command execution."""
    
    def test_github_pr_draft(self, snapshot):
        """
        Recorded test for: https://github.com/vercel/next.js/pull/40000
        
        This test captures the exact output of running:
        python onefilellm.py https://github.com/vercel/next.js/pull/40000
        """
        # Execute the command that was recorded
        args = ['https://github.com/vercel/next.js/pull/40000']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "github_pr_draft_527fe0aa")
    
    def test_github_pr_draft_success_expectation(self):
        """
