...
Test Name: github-issue-labels
Generated: 2025-06-12 15:59:00 UTC
Command: python onefilellm.py https://github.com/nodejs/node/issues/40000

Recorded test for: https://github.com/nodejs/node/issues/40000
...
class TestRecordedGithub_Issue_Labels:
    """Auto-generated test class for recorded command execution."""
    
    def test_github_issue_labels(self, snapshot):
        """
        Recorded test for: https://github.com/nodejs/node/issues/40000
        
        This test captures the exact output of running:
        python onefilellm.py https://github.com/nodejs/node/issues/40000
        """
        # Execute the command that was recorded
        args = ['https://github.com/nodejs/node/issues/40000']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "github_issue_labels_b856fec5")
    
    def test_github_issue_labels_success_expectation(self):
        """
