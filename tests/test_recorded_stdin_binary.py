...
Test Name: stdin-binary
Generated: 2025-06-12 15:53:19 UTC
...
@pytest.mark.unit
@pytest.mark.cli
class TestRecordedStdin_Binary:
    """Auto-generated test class for recorded command execution."""
    
    def test_stdin_binary(self, snapshot):
        """
        Recorded test for: -
        ...
        snapshot.assert_match(output, "stdin_binary_336d5ebc")
    
    def test_stdin_binary_success_expectation(self):
        """
