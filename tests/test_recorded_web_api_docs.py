...
Test Name: web-api-docs
Generated: 2025-06-12 15:58:54 UTC
Command: python onefilellm.py https://docs.github.com/en/rest

Recorded test for: https://docs.github.com/en/rest
...
class TestRecordedWeb_Api_Docs:
    """Auto-generated test class for recorded command execution."""
    
    def test_web_api_docs(self, snapshot):
        """
        Recorded test for: https://docs.github.com/en/rest
        
        This test captures the exact output of running:
        python onefilellm.py https://docs.github.com/en/rest
        """
        # Execute the command that was recorded
        args = ['https://docs.github.com/en/rest']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "web_api_docs_596c9c46")
    
    def test_web_api_docs_success_expectation(self):
        """
