...
Test Name: dir-dotfiles
Generated: 2025-06-12 16:01:47 UTC
Command: python onefilellm.py .git/

Recorded test for: .git/
...
class TestRecordedDir_Dotfiles:
    ...
    def test_dir_dotfiles(self, snapshot):
        ...
        snapshot.assert_match(output, "dir_dotfiles_891d5bba")
    
    def test_dir_dotfiles_success_expectation(self):
        """
