...
Test Name: github-small
Generated: 2025-06-12 15:52:52 UTC
Command: python onefilellm.py https://github.com/modelcontextprotocol/python-sdk

Recorded test for: https://github.com/modelcontextprotocol/python-sdk
...
class TestRecordedGithub_Small:
    """Auto-generated test class for recorded command execution."""
    
    def test_github_small(self, snapshot):
        """
        Recorded test for: https://github.com/modelcontextprotocol/python-sdk
        
        This test captures the exact output of running:
        python onefilellm.py https://github.com/modelcontextprotocol/python-sdk
        """
        # Execute the command that was recorded
        args = ['https://github.com/modelcontextprotocol/python-sdk']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "github_small_f19043ac")
    
    def test_github_small_success_expectation(self):
        """
