...
Test Name: complex-local-remote
Generated: 2025-06-12 16:01:36 UTC
Command: python onefilellm.py README.md src/ https://github.com/vercel/ai https://sdk.vercel.ai/docs

Recorded test for: README.md src/ https://github.com/vercel/ai https://sdk.vercel.ai/docs
...
class TestRecordedComplex_Local_Remote:
    """Auto-generated test class for recorded command execution."""
    
    def test_complex_local_remote(self, snapshot):
        """
        Recorded test for: README.md src/ https://github.com/vercel/ai https://sdk.vercel.ai/docs
        
        This test captures the exact output of running:
        python onefilellm.py README.md src/ https://github.com/vercel/ai https://sdk.vercel.ai/docs
        """
        # Execute the command that was recorded
        args = ['README.md', 'src/', 'https://github.com/vercel/ai', 'https://sdk.vercel.ai/docs']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "complex_local_remote_31643aa1")
    
    def test_complex_local_remote_success_expectation(self):
        """
