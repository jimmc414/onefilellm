...
Test Name: alias-invalid
Generated: 2025-06-12 15:56:58 UTC
Command: python onefilellm.py nonexistent-alias

Recorded test for: nonexistent-alias
...
@pytest.mark.unit
@pytest.mark.alias
class TestRecordedAlias_Invalid:
    """Auto-generated test class for recorded command execution."""
    
    def test_alias_invalid(self, snapshot):
        """
        Recorded test for: nonexistent-alias
        
        This test captures the exact output of running:
        python onefilellm.py nonexistent-alias
        """
        # Execute the command that was recorded
        args = ['nonexistent-alias']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "alias_invalid_c4871ddd")
    
    def test_alias_invalid_success_expectation(self):
        """
