...
Test Name: github-pr-reviews
Generated: 2025-06-12 16:04:10 UTC
Command: python onefilellm.py https://github.com/facebook/react/pull/20000

Recorded test for: https://github.com/facebook/react/pull/20000
...
class TestRecordedGithub_Pr_Reviews:
    """Auto-generated test class for recorded command execution."""
    
    def test_github_pr_reviews(self, snapshot):
        """
        Recorded test for: https://github.com/facebook/react/pull/20000
        
        This test captures the exact output of running:
        python onefilellm.py https://github.com/facebook/react/pull/20000
        """
        # Execute the command that was recorded
        args = ['https://github.com/facebook/react/pull/20000']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "github_pr_reviews_a270059c")
    
    def test_github_pr_reviews_success_expectation(self):
        """
