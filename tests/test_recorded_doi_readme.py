...
Test Name: doi-readme
Generated: 2025-06-12 16:07:43 UTC
Command: python onefilellm.py 10.1053/j.ajkd.2017.08.002

Recorded test for: 10.1053/j.ajkd.2017.08.002
...
class TestRecordedDoi_Readme:
    """Auto-generated test class for recorded command execution."""
    
    def test_doi_readme(self, snapshot):
        """
        Recorded test for: 10.1053/j.ajkd.2017.08.002
        
        This test captures the exact output of running:
        python onefilellm.py 10.1053/j.ajkd.2017.08.002
        """
        # Execute the command that was recorded
        args = ['10.1053/j.ajkd.2017.08.002']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "doi_readme_926f6c4c")
    
    def test_doi_readme_success_expectation(self):
        """
