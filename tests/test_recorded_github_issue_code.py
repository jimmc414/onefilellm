...
Test Name: github-issue-code
Generated: 2025-06-12 16:01:25 UTC
Command: python onefilellm.py https://github.com/prettier/prettier/issues/10000

Recorded test for: https://github.com/prettier/prettier/issues/10000
...
class TestRecordedGithub_Issue_Code:
    """Auto-generated test class for recorded command execution."""
    
    def test_github_issue_code(self, snapshot):
        """
        Recorded test for: https://github.com/prettier/prettier/issues/10000
        
        This test captures the exact output of running:
        python onefilellm.py https://github.com/prettier/prettier/issues/10000
        """
        # Execute the command that was recorded
        args = ['https://github.com/prettier/prettier/issues/10000']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "github_issue_code_288eb9be")
    
    def test_github_issue_code_success_expectation(self):
        """
