...
Test Name: alias-simple
Generated: 2025-06-12 15:54:44 UTC
Command: python onefilellm.py test-repo

Recorded test for: test-repo
...
class TestRecordedAlias_Simple:
    ...
    def test_alias_simple(self, snapshot):
        ...
        snapshot.assert_match(output, "alias_simple_6f6aef15")
    
    def test_alias_simple_success_expectation(self):
        """
