...
Test Name: help-basic
Generated: 2025-06-12 06:54:28 UTC
Command: python onefilellm.py --help-topic basic

Test recorded for command: onefilellm.py --help-topic basic
...
@pytest.mark.unit
@pytest.mark.cli
class TestRecordedHelp_Basic:
    """Auto-generated test class for recorded command execution."""
    
    def test_help_basic(self, snapshot):
        """
        Test recorded for command: onefilellm.py --help-topic basic
        ...
        snapshot.assert_match(output, "help_basic_761d2e37")
    
    def test_help_basic_success_expectation(self):
        """
