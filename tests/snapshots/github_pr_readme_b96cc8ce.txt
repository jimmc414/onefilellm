...
Processing: https://github.com/dear-github/dear-github/pull/102

Fetching PR data for: https://github.com/dear-github/dear-github/pull/102
Fetching PR diff...
Fetching PR comments...
Fetching PR review comments...
Fetching associated repository content from: 
https://github.com/dear-github/dear-github
Processing README.md...
GitHub repository processing finished.
Pull request 102 and repository content processed successfully.
Successfully processed: https://github.com/dear-github/dear-github/pull/102
...
Summary:
  - Sources Processed: 1
  - Final Output Size: 7.10 KB

Content Token Count (tiktoken): 1,653
Estimated Model Token Count (incl. overhead): 2,265
