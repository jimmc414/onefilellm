...
Test Name: github-pr-large
Generated: 2025-06-12 16:03:46 UTC
Command: python onefilellm.py https://github.com/kubernetes/kubernetes/pull/100000

Recorded test for: https://github.com/kubernetes/kubernetes/pull/100000
...
class TestRecordedGithub_Pr_Large:
    """Auto-generated test class for recorded command execution."""
    
    def test_github_pr_large(self, snapshot):
        """
        Recorded test for: https://github.com/kubernetes/kubernetes/pull/100000
        
        This test captures the exact output of running:
        python onefilellm.py https://github.com/kubernetes/kubernetes/pull/100000
        """
        # Execute the command that was recorded
        args = ['https://github.com/kubernetes/kubernetes/pull/100000']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "github_pr_large_d76ec7d5")
    
    def test_github_pr_large_success_expectation(self):
        """
