...
Test Name: local-yaml-file
Generated: 2025-06-12 15:53:22 UTC
Command: python onefilellm.py CLAUDE.md

Recorded test for: CLAUDE.md
...
class TestRecordedLocal_Yaml_File:
    ...
    def test_local_yaml_file(self, snapshot):
        ...
        snapshot.assert_match(output, "local_yaml_file_052a1484")
    
    def test_local_yaml_file_success_expectation(self):
        """
