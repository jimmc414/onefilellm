...
Test Name: multi-format
Generated: 2025-06-12 16:06:16 UTC
Command: python onefilellm.py readme.md onefilellm.py integration_test.json --format text

Recorded test for: readme.md onefilellm.py integration_test.json --format text
...
class TestRecordedMulti_Format:
    """Auto-generated test class for recorded command execution."""
    
    def test_multi_format(self, snapshot):
        """
        Recorded test for: readme.md onefilellm.py integration_test.json --format text
        
        This test captures the exact output of running:
        python onefilellm.py readme.md onefilellm.py integration_test.json --format text
        """
        # Execute the command that was recorded
        args = ['readme.md', 'onefilellm.py', 'integration_test.json', '--format', 'text']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "multi_format_fb0af264")
    
    def test_multi_format_success_expectation(self):
        """
