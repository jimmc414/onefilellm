...
Test Name: github-pr-merged
Generated: 2025-06-12 16:03:19 UTC
Command: python onefilellm.py https://github.com/microsoft/vscode/pull/150000

Recorded test for: https://github.com/microsoft/vscode/pull/150000
...
class TestRecordedGithub_Pr_Merged:
    """Auto-generated test class for recorded command execution."""
    
    def test_github_pr_merged(self, snapshot):
        """
        Recorded test for: https://github.com/microsoft/vscode/pull/150000
        
        This test captures the exact output of running:
        python onefilellm.py https://github.com/microsoft/vscode/pull/150000
        """
        # Execute the command that was recorded
        args = ['https://github.com/microsoft/vscode/pull/150000']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "github_pr_merged_42e2b85a")
    
    def test_github_pr_merged_success_expectation(self):
        """
