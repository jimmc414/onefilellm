...
Test Name: error-permission
Generated: 2025-06-12 16:03:14 UTC
Command: python onefilellm.py /root/protected-file

Recorded test for: /root/protected-file
...
class TestRecordedError_Permission:
    """Auto-generated test class for recorded command execution."""
    
    def test_error_permission(self, snapshot):
        """
        Recorded test for: /root/protected-file
        
        This test captures the exact output of running:
        python onefilellm.py /root/protected-file
        """
        # Execute the command that was recorded
        args = ['/root/protected-file']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "error_permission_7bc3a906")
    
    def test_error_permission_success_expectation(self):
        """
