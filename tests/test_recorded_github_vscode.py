...
Test Name: github-vscode
Generated: 2025-06-12 15:52:06 UTC
Command: python onefilellm.py https://github.com/microsoft/vscode

Recorded test for: https://github.com/microsoft/vscode
...
class TestRecordedGithub_Vscode:
    """Auto-generated test class for recorded command execution."""
    
    def test_github_vscode(self, snapshot):
        """
        Recorded test for: https://github.com/microsoft/vscode
        ...
        args = ['https://github.com/microsoft/vscode']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "github_vscode_429ceefb")
    
    def test_github_vscode_success_expectation(self):
        """
