...
Test Name: complex-readme
Generated: 2025-06-12 15:59:34 UTC
Command: python onefilellm.py ./src/ https://github.com/jimmc414/onefilellm/issues/1 https://react.dev/

Recorded test for: ./src/ https://github.com/jimmc414/onefilellm/issues/1 https://react.dev/
...
class TestRecordedComplex_Readme:
    """Auto-generated test class for recorded command execution."""
    
    def test_complex_readme(self, snapshot):
        """
        Recorded test for: ./src/ https://github.com/jimmc414/onefilellm/issues/1 https://react.dev/
        ...
        args = ['./src/', 'https://github.com/jimmc414/onefilellm/issues/1', 'https://react.dev/']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "complex_readme_4480de56")
    
    def test_complex_readme_success_expectation(self):
        """
