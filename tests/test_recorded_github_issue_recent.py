...
Test Name: github-issue-recent
Generated: 2025-06-12 15:58:04 UTC
Command: python onefilellm.py https://github.com/microsoft/vscode/issues/200000

Recorded test for: https://github.com/microsoft/vscode/issues/200000
...
class TestRecordedGithub_Issue_Recent:
    """Auto-generated test class for recorded command execution."""
    
    def test_github_issue_recent(self, snapshot):
        """
        Recorded test for: https://github.com/microsoft/vscode/issues/200000
        
        This test captures the exact output of running:
        python onefilellm.py https://github.com/microsoft/vscode/issues/200000
        """
        # Execute the command that was recorded
        args = ['https://github.com/microsoft/vscode/issues/200000']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "github_issue_recent_a14a69e7")
    
    def test_github_issue_recent_success_expectation(self):
        """
