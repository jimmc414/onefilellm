...
Test Name: github-issue-reactions
Generated: 2025-06-12 15:58:31 UTC
Command: python onefilellm.py https://github.com/facebook/react/issues/10000

Recorded test for: https://github.com/facebook/react/issues/10000
...
class TestRecordedGithub_Issue_Reactions:
    """Auto-generated test class for recorded command execution."""
    
    def test_github_issue_reactions(self, snapshot):
        """
        Recorded test for: https://github.com/facebook/react/issues/10000
        
        This test captures the exact output of running:
        python onefilellm.py https://github.com/facebook/react/issues/10000
        """
        # Execute the command that was recorded
        args = ['https://github.com/facebook/react/issues/10000']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "github_issue_reactions_d14fb837")
    
    def test_github_issue_reactions_success_expectation(self):
        """
