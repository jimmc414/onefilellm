...
Test Name: web-vercel-sdk
Generated: 2025-06-12 15:55:22 UTC
Command: python onefilellm.py https://sdk.vercel.ai/docs

Recorded test for: https://sdk.vercel.ai/docs
...
class TestRecordedWeb_Vercel_Sdk:
    """Auto-generated test class for recorded command execution."""
    
    def test_web_vercel_sdk(self, snapshot):
        """
        Recorded test for: https://sdk.vercel.ai/docs
        
        This test captures the exact output of running:
        python onefilellm.py https://sdk.vercel.ai/docs
        """
        # Execute the command that was recorded
        args = ['https://sdk.vercel.ai/docs']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "web_vercel_sdk_e2aac598")
    
    def test_web_vercel_sdk_success_expectation(self):
        """
