...
Command: python onefilellm.py tests/

Recorded test for: tests/
...
class TestRecordedDir_Tests:
    ...
    def test_dir_tests(self, snapshot):
        ...
        snapshot.assert_match(output, "dir_tests_59425e44")
    
    def test_dir_tests_success_expectation(self):
        """
