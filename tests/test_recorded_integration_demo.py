...
Test Name: integration-demo
Generated: 2025-06-12 06:56:15 UTC
Command: python onefilellm.py sample_test.txt

Recorded test for: sample_test.txt
...
class TestRecordedIntegration_Demo:
    """Auto-generated test class for recorded command execution."""
    
    def test_integration_demo(self, snapshot):
        """
        Recorded test for: sample_test.txt
        
        This test captures the exact output of running:
        python onefilellm.py sample_test.txt
        """
        # Execute the command that was recorded
        args = ['sample_test.txt']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "integration_demo_f49319a8")
    
    def test_integration_demo_success_expectation(self):
        """
