...
Test Name: stdin-simple
Generated: 2025-06-12 15:51:13 UTC
...
@pytest.mark.unit
@pytest.mark.cli
class TestRecordedStdin_Simple:
    """Auto-generated test class for recorded command execution."""
    
    def test_stdin_simple(self, snapshot):
        """
        Recorded test for: -
        ...
        snapshot.assert_match(output, "stdin_simple_336d5ebc")
    
    def test_stdin_simple_success_expectation(self):
        """
