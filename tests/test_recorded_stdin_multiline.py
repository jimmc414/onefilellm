...
Test Name: stdin-multiline
Generated: 2025-06-12 15:53:02 UTC
Command: python onefilellm.py -
...
@pytest.mark.unit
@pytest.mark.cli
class TestRecordedStdin_Multiline:
    """Auto-generated test class for recorded command execution."""
    
    def test_stdin_multiline(self, snapshot):
        """
        Recorded test for: -
        ...
        snapshot.assert_match(output, "stdin_multiline_336d5ebc")
    
    def test_stdin_multiline_success_expectation(self):
        """
