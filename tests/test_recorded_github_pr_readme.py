...
Test Name: github-pr-readme
Generated: 2025-06-12 16:02:57 UTC
Command: python onefilellm.py https://github.com/dear-github/dear-github/pull/102

Recorded test for: https://github.com/dear-github/dear-github/pull/102
...
class TestRecordedGithub_Pr_Readme:
    """Auto-generated test class for recorded command execution."""
    
    def test_github_pr_readme(self, snapshot):
        """
        Recorded test for: https://github.com/dear-github/dear-github/pull/102
        
        This test captures the exact output of running:
        python onefilellm.py https://github.com/dear-github/dear-github/pull/102
        """
        # Execute the command that was recorded
        args = ['https://github.com/dear-github/dear-github/pull/102']
        
        # Run the program and capture output
        output = run_program(args)
        
        # Assert against the recorded snapshot
        snapshot.assert_match(output, "github_pr_readme_b96cc8ce")
    
    def test_github_pr_readme_success_expectation(self):
        """
