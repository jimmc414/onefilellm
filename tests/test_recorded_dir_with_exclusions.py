...
Test Name: dir-with-exclusions
Generated: 2025-06-12 15:59:32 UTC
Command: python onefilellm.py docs/

Recorded test for: docs/
...
@pytest.mark.unit
class TestRecordedDir_With_Exclusions:
    """Auto-generated test class for recorded command execution."""
    
    def test_dir_with_exclusions(self, snapshot):
        """
        Recorded test for: docs/
        
        This test captures the exact output of running:
        python onefilellm.py docs/
        """
        ...
        snapshot.assert_match(output, "dir_with_exclusions_49e56c81")
    
    def test_dir_with_exclusions_success_expectation(self):
        """
